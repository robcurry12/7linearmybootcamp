...
<body>
	...
	<div class="hidden home" id="register">
		...
		<form class="noenter" method="post">
			<label>Username: </label>
			<input class="text" id="newuser" type="text" name="newuser" maxlength="20"/> <span class="validation" id="newuser-result"></span><br>
			
			<!--- Stylize HTML error message --->
			<label>Email: </label>
			<input class="text" id="newemail" type="email" name="newemail1"/> <span class="validation" id="newemail-result"></span> <br>
			
			<label>Confirm Email: </label>
			<input class="text" id="confirmemail" type="email" name="newemail2"/><span class="validation" id="confirmemail-result"></span><br>
			
			<label>Password: </label>
			<input class="text" type="password" id="newpass1" name="newpass1"/><span class="validation" id="newpass-result"></span><br>
			
			<label>Confirm Password: </label>
			<input class="text" type="password" id="newpass2" name="newpass2" /><span class="validation" id="con_pass-result"></span><br>
